        ...
        <nav className="w-screen fixed top-0 z-10 ">
            <div className="max-w-screen flex flex-wrap items-center justify-between bg-gray-950 mx-auto p-4 z-[1000]">
                <a className="flex items-center text-white">
                    <img src="/logo.svg" className="h-8 mr-3" alt="Flowbite Logo" />AGC
                </a>
            ...
            <div className={`absolute items-center justify-between top-[50px] w-1/2 bg-gray-950 md:flex md:w-auto  transition-al z-0 ${nav ? 'right-0' : 'right-[-400px]'} lg:right-[35px] lg:top-[20px]`} >
                <ul className="flex flex-col bg-transparent p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg  md:flex-row md:space-x-8 md:mt-0 md:border-0 lg:flex-row">
                    <li>
                        <a href="#" className="block py-2 pl-3 pr-4 text-gray-200 bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 " aria-current="page">Inicio</a>
                    </li>
                    <li>
                        <a href="#Servicios" className="block py-2 pl-3 pr-4 text-gray-200 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0">Servicios</a>
                    </li>
                    <li>
